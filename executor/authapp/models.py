...
class PyWebUserProfile(models.Model):
    ...
    zipcode = models.CharField(verbose_name='zipcode',
                               max_length=16,
                               blank=True)
    ...
    socials = models.CharField(verbose_name='socials',
                               max_length=512,
                               blank=True)
    proglangs = models.CharField(verbose_name='programming languages',
                                 max_length=512,
                                 blank=True)
