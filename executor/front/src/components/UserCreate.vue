<template>
  <div class="create-user-form">
    ...
    <div class="create-user-buttons">
      <button @click="create()" class="create-user-button btn btn-outline-success">Sign up</button>
      <button
        @click="resetInitData()"
        type="reset"
        class="create-user-button btn btn-outline-danger"
      >Clear</button>
    </div>
