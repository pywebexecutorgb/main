    ...
    <div class="reset-password-form">
        ...
        <div class="input-form">
            <div class="input-group mb-1">
                ...
                <input id="passwordNew" type="password" class="form-control" placeholder="password"
                       v-model="passwordNew" aria-describedby="password-addon" data-type="password"
        ...
        <div class="input-form">
            <div class="input-group mb-1">
                ...
                <input id="passwordNewConfirm" type="password" class="form-control" placeholder="confirm password"
                       v-model="passwordNewConfirm" aria-describedby="password-confirm-addon" data-type="password"
                       @change="isValidPassword()">
            </div>
        </div>
        ...
        <div class="reset-password-buttons">
            <button @click="resetPassword()"
                    class="reset-password-button btn btn-outline-success">Reset password
            </button>
            <button @click="resetInitData()" type="reset"
                    class="reset-password-button btn btn-outline-danger">Clear
            </button>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showSuccess(message) {
        this.showElementMessageClass("error-reset-password", `${message} Redirect after 5 seconds.`, "successful");
      ...
      isValidPassword() {
        if (this.passwordNew !== this.passwordNewConfirm) {
          ...
          document.getElementById('passwordNewConfirm').classList.add("error-input");
          this.showError('Passwords are not equal');
          return false;
        }

        document.getElementById('passwordNew').classList.remove("error-input");
        document.getElementById('passwordNewConfirm').classList.remove("error-input");
        this.hideError();
